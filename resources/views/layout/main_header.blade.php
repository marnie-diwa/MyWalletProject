...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="sidebar-card d-none d-lg-flex">
                <img class="sidebar-card-illustration mb-2" src="{{asset('layouts/img/undraw_rocket.svg')}}" alt="...">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" src="{{asset('layouts/img/undraw_profile.svg')}}">
                            </a>
    ...
    <!-- Page level plugins -->
    <script src="{{asset('layouts/vendor/chart.js/Chart.min.js')}}"></script>

    <!-- Page level custom scripts -->
    <script src="{{asset('layouts/js/demo/chart-area-demo.js')}}"></script>
    <script src="{{asset('layouts/js/demo/chart-pie-demo.js')}}"></script>
